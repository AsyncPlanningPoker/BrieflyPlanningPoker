import { createUser, login, passRecovery, passUpdate, deleteUser, nameAndPassUpdate } from '../schemas/user';
...
routes.put('/user', checkSchema(nameAndPassUpdate), schema.handler, user.nameAndPassUpdate);
