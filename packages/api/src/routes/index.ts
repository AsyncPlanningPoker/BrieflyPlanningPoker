...
routes.post('/squad', auth.handler, squad.create);
routes.get('/squad', auth.handler, squad.findAll);
routes.put('/squad/:squadId', auth.handler, squad.update);
routes.get('/squad/:squadId', auth.handler, squad.find);
routes.post('/squad/:squadId/users', auth.handler, squad.addUsers);
